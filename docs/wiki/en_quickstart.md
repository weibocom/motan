...
#### <a id="zookeeper-start"></a>Install and Start Zookeeper([Official Docs](https://zookeeper.apache.org/doc/trunk/zookeeperStarted.html))

Install and Start single machine Zookeeper
...
2. Add the definition of zookeeper registry in the configuration of server and client. 
    ...
    using zookeeper as single node
    
    ```xml
    <motan:registry regProtocol="zookeeper" name="my_zookeeper" address="127.0.0.1:2181"/>
    ```
    
    using zookeeper as multi-node cluster  
