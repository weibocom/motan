            ...
            if (zkChildListener == null) {
                childChangeListeners.putIfAbsent(serviceListener, new IZkChildListener() {
                    ...
                    public void handleChildChange(String parentPath, List<String> currentChilds) {
                        ...
                        LoggerUtil.info(String.format("[CommandZookeeperRegistry] service list change: path=%s, currentChilds=%s", parentPath, currentChilds.toString()));
                    }
                });
            ...
            if (zkDataListener == null) {
                dataChangeListeners.putIfAbsent(commandListener, new IZkDataListener() {
                    ...
                    public void handleDataChange(String dataPath, Object data) throws Exception {
                        ...
                        LoggerUtil.info(String.format("[CommandZookeeperRegistry] command data change: path=%s, command=%s", dataPath, (String) data));
                    }

                    @Override
                    public void handleDataDeleted(String dataPath) throws Exception {
                        commandListener.notifyCommand(url, null);
                        LoggerUtil.info(String.format("[CommandZookeeperRegistry] command deleted: path=%s", dataPath));
                    }
                });
